...
# treatments_as_patient = db.relationship('Treatment', backref='patient', foreign_keys='Treatment.patient_id')
# treatments_as_therapist = db.relationship('Treatment', backref='therapist', foreign_keys='Treatment.therapist_id')
